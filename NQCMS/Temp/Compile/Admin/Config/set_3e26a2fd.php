...
URL = 'http://localhost/11/1101/index.php/Admin/Config/set';
...
CONTROLLER = 'http://localhost/11/1101/index.php/Admin/Config';
ACTION = 'http://localhost/11/1101/index.php/Admin/Config/set';
...
CONTROLLERVIEW = 'http://localhost/11/1101/NQCMS/Admin/View/Config';
...
<body>
	<div class='wrap'>
	<form action="">
		<div class="title-header">网站配置</div>
...
if($_index_d>=$_total_d):$hd["list"]["d"]["last"]=true;endif;?>
				...
				<tr >
					<th class="w200"><?php echo $d['title'];?></th>
					<td><?php echo $d['_html'];?></td>
				</tr>
...
echo "";
		...
		<div class='position-bottom'>
			<input type="submit" value='修改' class='hd-success'>
		</div>
	</form>
	</div>
	<script type="text/javascript" src="http://localhost/11/1101/NQCMS/Admin/View/Config/Js/js.js"></script>
</body>
</html>