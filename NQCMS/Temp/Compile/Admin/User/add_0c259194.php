...
URL = 'http://localhost/11/1101/index.php/Admin/User/add';
...
ACTION = 'http://localhost/11/1101/index.php/Admin/User/add';
	...
	<form action="" method="post" name="add">
		<div class="menu_list">
			...
			<table class="table2 hd-form">
				...
				<script type="text/javascript" src="http://localhost/11/1101/NQCMS/Admin/View/User/Js/js.js"></script>
		</div>
		</form>
	</div>
</body>
