...
<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?><div id="top">
	<div class="warp clearfix">
		...
		<ul class="nav clearfix">
			...
			<a href="<?php echo U('about',array('aid'=>'24','cid'=>'3'));?>" title="公司简介" class="bg1" target="_blank"><span>公司简介</span></a>
			</li>
			<li onMouseOver="$('.nav .bg3 span').addClass('cur');" onMouseOut="$('.nav .bg3 span').removeClass('cur');">
			<a href="<?php echo U('showlist',array('cid'=>'2'));?>" title="新闻资讯" class="bg3" target="_blank"><span>新闻资讯</span></a>
			</li>
			<li onMouseOver="$('.nav .bg6 span').addClass('cur');" onMouseOut="$('.nav .bg6 span').removeClass('cur');">
			<a href="<?php echo U('content',array('aid'=>25,'cid'=>8));?>" title="联系我们" class="bg6" target="_blank"><span>联系我们</span></a>
			</li>
		</ul>
	</div>
	<div class="subnav">
...
<div id="banner_inner">
	...
	<div class="warp">
		<h2><a href="/xinwenzixun"><?php echo $cms['catname'];?><br><span>News information</span></a></h2>
	</div>
</div>
<div class="warp clearfix">
	<div class="c_l">
	<dl class="left_nav">					
		...
		<ul class="list_left_btn">
			<li><a href="/chanpinzonghui"><img src="http://localhost/11/1101/Template/default/images/btn_products.jpg"></a></li>
			<li><a href="/lianxiwomen"><img src="http://localhost/11/1101/Template/default/images/btn_contact.jpg"></a></li>
			<li><img src="http://localhost/11/1101/Template/default/images/btn_rexian.jpg"></li>
		</ul>
		<div class="list_left">
			<p class="title">重点推荐</p>
			<ul>
				<li><a href="content.html">·超市冷柜直冷式和风冷式独具</a></li>
	...
	<div class="c_r">
		<div class="pos">
			<h2>新闻资讯</h2>
			<p> <a href='index.html'>首页</a> > <a href='newsList.html'>新闻资讯</a> > </p>
		</div>
		<div class="list_news">
					<?php
				$cid=$_GET['cid'];
